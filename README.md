...
* What drives revenue across products?
* Do pricing and discounts influence customer demand?
* How do product ratings impact sales performance?
* Are a few products dominating overall revenue?
...
* **Pricing Impact:** Sales volume remains relatively consistent across price ranges, but higher-priced products generate significantly more revenue, making them key contributors.

* **Discount Strategy:** Increasing discounts leads to only a marginal increase in sales quantity while reducing overall revenue, suggesting over-discounting may not be effective.

* **Customer Ratings:** Higher-rated products tend to generate more revenue, highlighting the importance of customer satisfaction and trust.
